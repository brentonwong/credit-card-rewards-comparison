...
const App: FC = () => {
  ...
  return (
    <>
      <div className="w-full py-36 bg-green-100 px-6 flex items-center justify-center">
      ...
      <footer className="w-full flex justify-center bg-gray-100 py-16">
        <div className="w-full max-w-6xl">
          <p className="text-center text-xs mb-0">
            Disclaimer: This tool provides estimates and is not affiliated with
            any banks. Verify details with the respective institutions.
          </p>
        </div>
      </footer>
    </>
